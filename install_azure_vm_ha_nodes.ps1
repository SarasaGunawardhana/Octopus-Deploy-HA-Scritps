...
"Setup Octopus Node" | Out-File -FilePath $LogFileLocation -append

$url = "https://raw.githubusercontent.com/SarasaGunawardhana/Octopus-Deploy-HA-Scritps/refs/heads/main/setup_octopus_ha_nodes.ps1"

(-join("Getting File from = ", $url)) | Out-File -FilePath $LogFileLocation -append

$outpath = "$PSScriptRoot\setup_octopus_ha_nodes.ps1"
